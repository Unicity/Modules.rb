...
require "./task_gambler.rb"

module Unicity

	module BT

		class TaskGamblerFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskGambler"
				...
				if !object.is_a?(Unicity::BT::TaskGambler)
					raise Exception.new("Invalid type defined. Expected a task gambler, but got an element of type \"#{type}\" instead.")
				end
