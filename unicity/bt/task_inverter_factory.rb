...
require "./task_inverter.rb"

module Unicity

	module BT

		class TaskInverterFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskInverter"
				...
				if !object.is_a?(Unicity::BT::TaskInverter)
					raise Exception.new("Invalid type defined. Expected a task inverter, but got an element of type \"#{type}\" instead.")
				end
