...
module Unicity
	...
	module BT
		...
		class TaskFailerFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskFailer"
				...
				if !object.is_a?(Unicity::BT::TaskFailer)
					raise Exception.new("Invalid type defined. Expected a task failer, but got an element of type \"#{type}\" instead.")
				end
