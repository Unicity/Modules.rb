	...
	module BT
		...
		class TaskCompositeFactory
			...
			def getObject(parser, element)
				...
				if !object.is_a?(Unicity::BT::TaskComposite)
					raise Exception.new("Invalid type defined. Expected a task composite, but got an element of type \"#{type}\" instead.")
				end
