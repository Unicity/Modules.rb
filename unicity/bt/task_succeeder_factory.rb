...
require "./task_succeeder.rb"

module Unicity

	module BT

		class TaskSucceederFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskSucceeder"
				...
				if !object.is_a?(Unicity::BT::TaskSucceeder)
					raise Exception.new("Invalid type defined. Expected a task succeeder, but got an element of type \"#{type}\" instead.")
				end
