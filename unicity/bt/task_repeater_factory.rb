...
require "./task_repeater.rb"

module Unicity

	module BT

		class TaskRepeaterFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskRepeater"
				...
				if !object.is_a?(Unicity::BT::TaskRepeater)
					raise Exception.new("Invalid type defined. Expected a task repeater, but got an element of type \"#{type}\" instead.")
				end
