...
require "./task_semaphore.rb"

module Unicity

	module BT

		class TaskSemaphoreFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskSemaphore"
				...
				if !object.is_a?(Unicity::BT::TaskSemaphore)
					raise Exception.new("Invalid type defined. Expected a task semaphore, but got an element of type \"#{type}\" instead.")
				end
