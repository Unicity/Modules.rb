...
require "./task_ticker.rb"

module Unicity

	module BT

		class TaskTickerFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskTicker"
				...
				if !object.is_a?(Unicity::BT::TaskTicker)
					raise Exception.new("Invalid type defined. Expected a task ticker, but got an element of type \"#{type}\" instead.")
				end
