...
module Unicity
	...
	module BT
		...
		class TaskPickerFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskPicker"
				...
				if !object.is_a?(Unicity::BT::TaskPicker)
					raise Exception.new("Invalid type defined. Expected a task picker, but got an element of type \"#{type}\" instead.")
				end
