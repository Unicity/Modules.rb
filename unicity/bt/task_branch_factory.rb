	...
	module BT
		...
		class TaskBranchFactory
			...
			def getObject(parser, element)
				...
				if !object.is_a?(Unicity::BT::TaskBranch)
					raise Exception.new("Invalid type defined. Expected a task branch, but got an element of type \"#{type}\" instead.")
				end
