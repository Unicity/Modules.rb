...
module Unicity
	...
	module BT
		...
		class TaskSequenceFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskSequence"
				...
				if !object.is_a?(Unicity::BT::TaskSequence)
					raise Exception.new("Invalid type defined. Expected a task sequence, but got an element of type \"#{type}\" instead.")
				end
