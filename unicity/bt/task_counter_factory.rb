...
require "./task_counter.rb"

module Unicity

	module BT

		class TaskCounterFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskCounter"
				...
				if !object.is_a?(Unicity::BT::TaskCounter)
					raise Exception.new("Invalid type defined. Expected a task counter, but got an element of type \"#{type}\" instead.")
				end
