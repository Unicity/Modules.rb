...
require "./task_resetter.rb"

module Unicity

	module BT

		class TaskResetterFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskResetter"
				...
				if !object.is_a?(Unicity::BT::TaskResetter)
					raise Exception.new("Invalid type defined. Expected a task resetter, but got an element of type \"#{type}\" instead.")
				end
