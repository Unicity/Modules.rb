...
require "./task_timer.rb"

module Unicity

	module BT

		class TaskTimerFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskTimer"
				...
				if !object.is_a?(Unicity::BT::TaskTimer)
					raise Exception.new("Invalid type defined. Expected a task timer, but got an element of type \"#{type}\" instead.")
				end
