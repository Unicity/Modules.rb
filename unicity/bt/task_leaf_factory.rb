	...
	module BT
		...
		class TaskLeafFactory
			...
			def getObject(parser, element)
				...
				if !object.is_a?(Unicity::BT::TaskLeaf)
					raise Exception.new("Invalid type defined. Expected a task leaf, but got an element of type \"#{type}\" instead.")
				end
