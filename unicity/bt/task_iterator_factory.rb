...
require "./task_iterator.rb"

module Unicity

	module BT

		class TaskIteratorFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskIterator"
				...
				if !object.is_a?(Unicity::BT::TaskIterator)
					raise Exception.new("Invalid type defined. Expected a task iterator, but got an element of type \"#{type}\" instead.")
				end
