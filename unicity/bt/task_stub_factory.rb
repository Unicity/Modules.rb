...
module Unicity
	...
	module BT
		...
		class TaskStubFactory

			def getObject(parser, element)
				itype = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskStub"
				...
				if !object.is_a?(Unicity::BT::TaskStub)
					raise Exception.new("Invalid type defined. Expected a task stub, but got an element of type \"#{type}\" instead.")
				end
