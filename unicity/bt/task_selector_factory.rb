...
module Unicity
	...
	module BT
		...
		class TaskSelectorFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskSelector"
				...
				if !object.is_a?(Unicity::BT::TaskSelector)
					raise Exception.new("Invalid type defined. Expected a task selector, but got an element of type \"#{type}\" instead.")
				end
