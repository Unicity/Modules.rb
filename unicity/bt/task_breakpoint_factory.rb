...
require "./task_breakpoint.rb"

module Unicity

	module BT

		class TaskBreakpointFactory

			def getObject(parser, element)
				type = !element["type"].nil? ? element["type"] : "Unicity::BT::TaskBreakpoint"
				...
				if !object.is_a?(Unicity::BT::TaskBreakpoint)
					raise Exception.new("Invalid type defined. Expected a task breakpoint, but got an element of type \"#{type}\" instead.")
				end
